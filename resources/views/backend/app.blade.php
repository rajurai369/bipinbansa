            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="/image" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> Uploade  Images </span></a
                    >
                  </li>

                  <li class="sidebar-item">
                    <a href="/file" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> Uploade Files </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                  ...
                  <li class="sidebar-item">
                    <a href="/tasbir" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu"> Pariwarik Tasbir </span></a
                    >
                  </li>
                </ul>
              </li>
