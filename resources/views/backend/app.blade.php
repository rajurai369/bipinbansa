            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/assets/images/final.jpg" alt="" class="light-logo" width="200"
                                height="70" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                  ...
                  "
                                ...
                                aria-expanded="false">
                                <img src="/assets/images/final.jpg" alt="user" class="rounded-circle"
                                    width="31" />
                            </a>
                    ...
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Post
                                </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="/photo" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                            class="hide-menu"> Uploade Images </span></a>
                                </li>

                                <li class="sidebar-item">
                                    <a href="/file" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                            class="hide-menu"> Uploade Files </span></a>
                                </li>
                                <li class="sidebar-item">
                                ...
                                <li class="sidebar-item">
                                    <a href="/tasbir" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                            class="hide-menu"> Pariwarik Tasbir </span></a>
                                </li>
                            </ul>
                        </li>
